...
namespace Vision.DAL
{
    ...
    public partial class tblLeaveAdjustment
    {
        ...
        public virtual tblLeaveAdjustmentNoPrefix tblLeaveAdjustmentNoPrefix { get; set; }
