...
namespace Vision.DAL
{
    ...
    public partial class tblMinimumWageCategory
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tblMinimumWageCategory()
        {
            this.tblEmployeeServiceDetails = new HashSet<tblEmployeeServiceDetail>();
            this.tblMinimumWageRates = new HashSet<tblMinimumWageRate>();
        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<tblMinimumWageRate> tblMinimumWageRates { get; set; }
    }
}
