...
{
    public class LeaveAdjustmentEditListModel : EditUserInfo
    {
        [Browsable(false)]
        ...
        [DisplayName("No")]
        public int LeaveAdjustmentNo { get; set; }
    }

    public class LeaveAdjustmentLookupListModel
    {
        [Browsable(false)]
        public int LeaveAdjustmentID { get; set; }
        ...
        [DisplayName("No")]
        public string LeaveAdjustmentNostr { get { return (LeaveAdjustmentNoPrefixName ?? "") + LeaveAdjustmentNo.ToString(); } }
